...
QSettings* s21::ViewOpenGLScene::GetState()
{
    return &state_;
};
...
void s21::ViewOpenGLScene::initializeGL() {
    ...
    glClearColor(state_.value("projection_colorR").toDouble(), state_.value("projection_colorG").toDouble(), state_.value("projection_colorB").toDouble(), 1.0);
};
...
void s21::ViewOpenGLScene::paintGL() {
    ...
    glColor3d(state_.value("lines_colorR").toDouble(),state_.value("lines_colorG").toDouble(),state_.value("lines_colorB").toDouble());
    ...
    case 0 :
    default:
        glColor3d(state_.value("vertices_colorR").toDouble(), state_.value("vertices_colorG").toDouble(),state_.value("vertices_colorB").toDouble());
